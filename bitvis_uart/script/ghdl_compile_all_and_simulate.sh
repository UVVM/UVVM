...
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/uart_bfm_pkg.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/transaction_pkg.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/vvc_cmd_pkg.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/monitor_cmd_pkg.vhd
...
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/vvc_methods_pkg.vhd
...
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/uart_rx_vvc.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/uart_tx_vvc.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/uart_vvc.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/uart_monitor.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_vip_uart ../../bitvis_vip_uart/src/vvc_context.vhd
...
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../src/uart_pkg.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../src/uart_pif_pkg.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../src/uart_pif.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../src/uart_core.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../src/uart.vhd

# Compiling UART VVC demo TB
echo "Compiling UART VVC demo TB..."
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../tb/uart_vvc_demo_th.vhd
ghdl -a -frelaxed-rules --std=08 -Wno-hide -Wno-shared --work=bitvis_uart ../tb/uart_vvc_demo_tb.vhd

# Running simulations
echo "Starting simulations..."
ghdl -e -frelaxed-rules --std=08 --work=bitvis_uart uart_vvc_demo_tb
ghdl -r -frelaxed-rules --std=08 --work=bitvis_uart uart_vvc_demo_tb
