...
def add_vvc_interpreter(file_handle):
    ...
    file_handle.write("      work.td_vvc_entity_support_pkg.await_cmd_from_sequencer(C_VVC_LABELS, vvc_config, THIS_VVCT, "+
                      "VVC_BROADCAST, global_vvc_ack, shared_vvc_cmd, v_local_vvc_cmd);\n")
    ...
    file_handle.write("              uvvm_vvc_framework.ti_vvc_framework_support_pkg.acknowledge_cmd(global_vvc_ack,v_local_vvc_cmd.cmd_idx);\n")
