...
Randomization
**********************************************************************************************************************************
Random values can be generated by using the uncovered bins to reduce simulation time. Once all the bins have been covered, random 
values will be generated using all the valid bins.
...
* When using HOLES_ONLY, only the uncovered bins are printed.
