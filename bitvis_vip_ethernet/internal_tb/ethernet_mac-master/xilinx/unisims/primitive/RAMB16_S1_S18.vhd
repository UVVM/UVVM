...
entity RAMB16_S1_S18 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S18 : entity is true;
end ramb16_s1_s18;

architecture RAMB16_S1_S18_V of RAMB16_S1_S18 is
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S18_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable INI_A             : std_logic_vector (0 downto 0)              := "0";
    ...
    variable SRVA_A            : std_logic_vector (0 downto 0)              := "0";
    ...
    variable DOA_zd  : std_logic_vector(0 downto 0) := INI_A(0 downto 0);
    ...
    variable ADDRA_ipd_sampled : std_logic_vector(13 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_A'length > 1) then
        ...
        INI_A(0 downto 0)                      := INI_A_UNBOUND(0 downto 0);

        for I in INI_A_UNBOUND'high downto 1 loop
      ...
      if (SRVAL_A'length > 1) then
        ...
        SRVA_A(0 downto 0)                       := SRVA_A_UNBOUND(0 downto 0);

        for I in SRVA_A_UNBOUND'high downto 1 loop
      ...
      DOA_zd(0 downto 0) := INI_A(0 downto 0);
    ...
    if (TimingChecksOn) then
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_ADDRA_CLKA_posedge_posedge(12),
        HoldHigh       => thold_ADDRA_CLKA_negedge_posedge(12),
        CheckEnabled   => TO_X01(ena_ipd_sampled) = '1',
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S1_S18",
        Xon            => Xon,
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S1_S18",
                       InstanceName => ramb16_s1_s18'path_name,
    ...
    wait on ADDRA_ipd, ADDRB_ipd, CLKA_ipd, CLKB_ipd, DIA_ipd, DIB_ipd, DIPB_ipd, ENA_ipd, ENB_ipd, SSRA_ipd, SSRB_ipd, WEA_ipd, WEB_ipd;
