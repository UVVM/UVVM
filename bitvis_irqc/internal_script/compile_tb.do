...
#------------------------------------------------------
set root_path "../.."
set tb_path "$root_path/bitvis_irqc/internal_tb"

echo "\n\n\n=== Compiling TB\n"

echo "eval vcom  $compdirectives  $tb_path/internal_irqc_tb.vhd"
eval vcom  $compdirectives  $tb_path/internal_irqc_tb.vhd
