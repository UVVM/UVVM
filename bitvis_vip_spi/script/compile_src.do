...
if { [string equal -nocase $simulator "modelsim"] } {
  set compdirectives "-2008 -quiet -suppress 1346,1236,1090 -work $lib_name"
...
eval vcom  $compdirectives  $vip_spi_part_path/../uvvm_vvc_framework/src_target_dependent/td_target_support_pkg.vhd
eval vcom  $compdirectives  $vip_spi_part_path/../uvvm_vvc_framework/src_target_dependent/td_vvc_framework_common_methods_pkg.vhd
eval vcom  $compdirectives  $vip_spi_part_path/src/vvc_methods_pkg.vhd
eval vcom  $compdirectives  $vip_spi_part_path/../uvvm_vvc_framework/src_target_dependent/td_queue_pkg.vhd
eval vcom  $compdirectives  $vip_spi_part_path/../uvvm_vvc_framework/src_target_dependent/td_vvc_entity_support_pkg.vhd
