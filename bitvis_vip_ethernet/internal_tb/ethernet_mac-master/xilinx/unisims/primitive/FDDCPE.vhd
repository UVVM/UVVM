-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/unisims/cpld/VITAL/FDDCPE.vhd,v 1.2 2008/12/18 17:58:58 vandanad Exp $
-------------------------------------------------------------------------------
...
attribute VITAL_LEVEL0 of FDDCPE : entity is TRUE;
end FDDCPE;
...
library UNISIM;
use unisim.VPKG.all;
architecture FDDCPE_V of FDDCPE is
   --attribute VITAL_LEVEL1 of FDDCPE_V : architecture is TRUE;
...
begin
   ...
   begin
      ...
      if (TimingChecksOn) then
         VitalSetupHoldCheck (
          ...
          CheckEnabled            => 
                           TO_X01(((NOT CLR_ipd)) AND (CE_ipd) AND ((NOT
                            PRE_ipd))) /= '0',
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/FDDCPE",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
          MsgSeverity             => WARNING);
         VitalSetupHoldCheck (
         ...
         VitalRecoveryRemovalCheck (
          ...
          ActiveLow               => FALSE,
          CheckEnabled            => 
                           TO_X01(((NOT PRE_ipd)) AND (CE_ipd)) /= '0',
          RefTransition           => 'R',
          HeaderMsg               => InstancePath & "/FDDCPE",
          Xon                     => Xon,
          MsgOn                   => MsgOn,
      ...
      -------------------------
      Violation := Tviol_D_C_posedge or Tviol_CLR_C_posedge or Tviol_PRE_C_posedge or Pviol_PRE or Pviol_C or Tviol_CE_C_posedge or Pviol_CLR;
      VitalStateTable(
        Result => Q_zd,
        PreviousDataIn => PrevData_Q,
        StateTable => FDDCPE_Q_tab,
        DataIn => (
               C_delayed, PRE_ipd, Q_zd, D_delayed, CE_delayed, C_ipd, CLR_ipd));
   ...
   wait on D_ipd, C_ipd, CE_ipd, CLR_ipd, PRE_ipd;
end process;
