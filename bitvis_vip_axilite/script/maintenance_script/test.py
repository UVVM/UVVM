...
# Add Avalon AXI VIP
hdlunit.add_files("../src/*.vhd", "bitvis_vip_axilite")
hdlunit.add_files("../../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_axilite")

# Add TB/TH
hdlunit.add_files("../tb/maintenance_tb/*.vhd", "bitvis_vip_axilite")
