...
entity RAMB16_S36_S36 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S36_S36 : entity is true;
end ramb16_s36_s36;

architecture RAMB16_S36_S36_V of RAMB16_S36_S36 is
  attribute VITAL_LEVEL0 of
    RAMB16_S36_S36_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOPA_OV_MSB       : integer := 3;
    ...
    variable INI_A             : std_logic_vector (35 downto 0)              := "000000000000000000000000000000000000";
    ...
    variable SRVA_A            : std_logic_vector (35 downto 0)              := "000000000000000000000000000000000000";
    ...
    variable DOA_zd  : std_logic_vector(31 downto 0) := INI_A(31 downto 0);
    ...
    variable ADDRA_ipd_sampled : std_logic_vector(8 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_A'length > 36) then
        ...
        for I in INI_A_UNBOUND'high downto 36 loop
      ...
      if (SRVAL_A'length > 36) then
        ...
        for I in SRVA_A_UNBOUND'high downto 36 loop
      ...
      DOA_zd(31 downto 0) := INI_A(31 downto 0);
      DOB_zd(31 downto 0) := INI_B(31 downto 0);
      DOPA_zd(3 downto 0) := INI_A(35 downto 32);
    ...
    if (TimingChecksOn) then
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIPA_CLKA_posedge_posedge(0),
        HoldHigh       => thold_DIPA_CLKA_negedge_posedge(0),
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIPA_CLKA_posedge_posedge(1),
        HoldHigh       => thold_DIPA_CLKA_negedge_posedge(1),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIPA_CLKA_posedge_posedge(2),
        HoldHigh       => thold_DIPA_CLKA_negedge_posedge(2),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(16),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(16),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(17),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(17),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(18),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(18),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(19),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(19),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(20),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(20),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(21),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(21),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(22),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(22),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(23),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(23),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(24),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(24),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(25),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(25),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(26),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(26),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(27),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(27),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(28),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(28),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(29),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(29),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_DIA_CLKA_posedge_posedge(30),
        HoldHigh       => thold_DIA_CLKA_negedge_posedge(30),
        CheckEnabled   => (TO_X01(ena_ipd_sampled) = '1' and TO_X01(wea_ipd_sampled) = '1'),
        RefTransition  => 'R',
        HeaderMsg      => "/RAMB16_S36_S36",
        Xon            => Xon,
    ...
    if (ena_ipd_sampled = '1')then
      if (rising_edge(CLKA_ipd)) then
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S36_S36",
                       InstanceName => ramb16_s36_s36'path_name,
        ...
        if (ssra_ipd_sampled = '1') then
          DOA_zd  := SRVA_A(31 downto 0);
          DOPA_zd := SRVA_A(35 downto 32);
        end if;
      end if;
    end if;
    ...
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(16),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(16), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(17),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(17), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(18),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(18), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(19),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(19), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(20),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(20), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(21),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(21), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(22),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(22), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(23),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(23), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(24),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(24), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(25),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(25), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(26),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(26), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(27),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(27), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(28),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(28), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(29),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(29), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(30),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(30), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOA_zd(31),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOA(31), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    ...
    VitalPathDelay01 (
      ...
      OutTemp       => DOPA_zd(1),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOPA(1), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOPA_zd(2),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOPA(2), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
    VitalPathDelay01 (
      ...
      OutTemp       => DOPA_zd(3),
      Paths         => (0 => (CLKA_ipd'last_event, tpd_CLKA_DOPA(3), true)),
      Mode          => OnEvent,
      Xon           => Xon,
      MsgOn         => MsgOn,
      MsgSeverity   => warning);
