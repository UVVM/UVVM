...
def add_vvc_executor(file_handle, vvc_channel):
	...
	print_linefeed(file_handle)
	file_handle.write("    procedure activity_watchdog_register_vvc_state(busy : boolean) is\n")
	file_handle.write("    begin\n")
	...
	file_handle.write("      gen_pulse(global_trigger_testcase_inactivity_watchdog, 0 ns, ""pulsing global trigger for inactivity watchdog"", C_SCOPE, ID_NEVER);\n")
	...
	file_handle.write("      activity_watchdog_register_vvc_state(false);\n")
	print_linefeed(file_handle)
	...
	print_linefeed(file_handle)
	file_handle.write("      -- Notify activity watchdog\n")
	file_handle.write("      activity_watchdog_register_vvc_state(true);\n")
	print_linefeed(file_handle)
