...
if {[file exists $vip_gpio_part_path/sim/$lib_name]} {
  file delete -force $vip_gpio_part_path/sim/$lib_name
}
...
eval vcom  $compdirectives  $vip_gpio_part_path/../uvvm_vvc_framework/src_target_dependent/td_target_support_pkg.vhd
eval vcom  $compdirectives  $vip_gpio_part_path/../uvvm_vvc_framework/src_target_dependent/td_vvc_framework_common_methods_pkg.vhd
eval vcom  $compdirectives  $vip_gpio_part_path/src/vvc_methods_pkg.vhd
eval vcom  $compdirectives  $vip_gpio_part_path/../uvvm_vvc_framework/src_target_dependent/td_queue_pkg.vhd
eval vcom  $compdirectives  $vip_gpio_part_path/../uvvm_vvc_framework/src_target_dependent/td_vvc_entity_support_pkg.vhd
