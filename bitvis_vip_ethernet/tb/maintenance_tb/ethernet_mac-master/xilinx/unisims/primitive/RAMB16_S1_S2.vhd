...
entity RAMB16_S1_S2 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S2 : entity is true;
end ramb16_s1_s2;

architecture RAMB16_S1_S2_V of RAMB16_S1_S2 is
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S2_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable INI_B             : std_logic_vector (1 downto 0)              := "00";
    ...
    variable SRVA_B            : std_logic_vector (1 downto 0)              := "00";
    ...
    variable DOB_zd  : std_logic_vector(1 downto 0) := INI_B(1 downto 0);

    variable ADDRA_ipd_sampled : std_logic_vector(13 downto 0) := (others => 'X');
    variable ADDRB_ipd_sampled : std_logic_vector(12 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_B'length > 2) then
        ...
        INI_B(1 downto 0)                      := INI_B_UNBOUND(1 downto 0);

        for I in INI_B_UNBOUND'high downto 2 loop
      ...
      if (SRVAL_B'length > 2) then
        ...
        SRVA_B(1 downto 0)                       := SRVA_B_UNBOUND(1 downto 0);

        for I in SRVA_B_UNBOUND'high downto 2 loop
      ...
      DOB_zd(1 downto 0) := INI_B(1 downto 0);
      DOA  <= DOA_zd;
      DOB  <= DOB_zd;
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S1_S2",
                       InstanceName => ramb16_s1_s2'path_name,
