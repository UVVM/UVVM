...
# Set lib_name
#------------------------------------------------------
quietly set lib_name bitvis_vip_rgmii
...
echo "eval vcom  $compdirectives  $source_path/src/rgmii_bfm_pkg.vhd"
eval vcom  $compdirectives  $source_path/src/rgmii_bfm_pkg.vhd
