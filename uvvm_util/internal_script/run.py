...
def run_simulation(library, testbench, tests, configs , verbose=False, clean_up = True):
...
def main(argv):
  ...
  testbench = "methods_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose, clean_up = False)
