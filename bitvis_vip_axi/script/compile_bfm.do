...
# Set lib_name
#------------------------------------------------------
quietly set lib_name bitvis_vip_axi
...
echo "eval vcom  $compdirectives  $source_path/src/axi_bfm_pkg.vhd"
eval vcom  $compdirectives  $source_path/src/axi_bfm_pkg.vhd