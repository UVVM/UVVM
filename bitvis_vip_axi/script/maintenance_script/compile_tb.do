...
#------------------------------------------------------
set root_path "../.."
set tb_path "$root_path/bitvis_vip_axi/tb/maintenance_tb"
echo "\n\n\n=== Compiling TB\n"


# TB - DUT
echo "eval vcom  $compdirectives  $tb_path/axi_slave_model_pkg.vhd"
eval vcom  $compdirectives  $tb_path/axi_slave_model_pkg.vhd

echo "eval vcom  $compdirectives  $tb_path/axi_slave_model.vhd"
eval vcom  $compdirectives  $tb_path/axi_slave_model.vhd
