...
# eval vcom  $compdirectives  $vip_axistream_part_path/internal_tb/axistream_fifo.vhd

# Compile Test Harness and Testbench
eval vcom  $compdirectives  $vip_axistream_part_path/internal_tb/axistream_th.vhd
eval vcom  $compdirectives  $vip_axistream_part_path/internal_tb/axistream_vvc_no_vunit_tb.vhd
#eval vcom  $compdirectives  $vip_axistream_part_path/internal_tb/axistream_multiple_vvc_tb.vhd
