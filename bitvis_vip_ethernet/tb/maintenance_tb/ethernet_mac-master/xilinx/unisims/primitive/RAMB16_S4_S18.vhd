...
entity RAMB16_S4_S18 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S4_S18 : entity is true;
end ramb16_s4_s18;

architecture RAMB16_S4_S18_V of RAMB16_S4_S18 is
  attribute VITAL_LEVEL0 of
    RAMB16_S4_S18_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable INI_A             : std_logic_vector (3 downto 0)              := "0000";
    ...
    variable SRVA_A            : std_logic_vector (3 downto 0)              := "0000";
    ...
    variable DOA_zd  : std_logic_vector(3 downto 0) := INI_A(3 downto 0);
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_A'length > 4) then
        ...
        INI_A(3 downto 0)                      := INI_A_UNBOUND(3 downto 0);

        for I in INI_A_UNBOUND'high downto 4 loop
      ...
      if (SRVAL_A'length > 4) then
        ...
        SRVA_A(3 downto 0)                       := SRVA_A_UNBOUND(3 downto 0);

        for I in SRVA_A_UNBOUND'high downto 4 loop
      ...
      DOA_zd(3 downto 0) := INI_A(3 downto 0);
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S4_S18",
                       InstanceName => ramb16_s4_s18'path_name,
