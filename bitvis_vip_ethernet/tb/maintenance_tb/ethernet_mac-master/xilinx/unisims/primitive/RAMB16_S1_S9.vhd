...
entity RAMB16_S1_S9 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S9 : entity is true;
end ramb16_s1_s9;

architecture RAMB16_S1_S9_V of RAMB16_S1_S9 is
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S9_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOPB_OV_MSB       : integer := 0;
    ...
    variable INI_B             : std_logic_vector (8 downto 0)              := "000000000";
    ...
    variable SRVA_B            : std_logic_vector (8 downto 0)              := "000000000";
    ...
    variable DOB_zd  : std_logic_vector(7 downto 0) := INI_B(7 downto 0);
    variable DOPB_zd : std_logic_vector(0 downto 0)  := INI_B(8 downto 8);

    variable ADDRA_ipd_sampled : std_logic_vector(13 downto 0) := (others => 'X');
    variable ADDRB_ipd_sampled : std_logic_vector(10 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_B'length > 9) then
        ...
        INI_B(8 downto 0)                      := INI_B_UNBOUND(8 downto 0);

        for I in INI_B_UNBOUND'high downto 9 loop
      ...
      if (SRVAL_B'length > 9) then
        ...
        SRVA_B(8 downto 0)                       := SRVA_B_UNBOUND(8 downto 0);

        for I in SRVA_B_UNBOUND'high downto 9 loop
      ...
      DOB_zd(7 downto 0) := INI_B(7 downto 0);
      DOPB_zd(0 downto 0) := INI_B(8 downto 8);
      DOA  <= DOA_zd;
      DOB  <= DOB_zd;
      DOPB <= DOPB_zd;
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S1_S9",
                       InstanceName => ramb16_s1_s9'path_name,
    ...
    if (enb_ipd_sampled = '1') then
      if (rising_edge(CLKB_ipd)) then
        ...
        if (ssrb_ipd_sampled = '1') then
          DOB_zd  := SRVA_B(7 downto 0);
          DOPB_zd := SRVA_B(8 downto 8);
        end if;
      end if;
    end if;
