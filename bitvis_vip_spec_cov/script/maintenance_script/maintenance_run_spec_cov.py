...
test_list = [
    ...
    [
        ...
        "0",
        "-r",
        "../tb/maintenance_tb/req_file.csv",
        "-p",
        "../sim/pc_2.csv",
        "-s",
        "../sim/sc_2.csv",
    ...
    [
        ...
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_1_strict_0.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_1_strict_1.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_1_strict_2.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_2_strict_0.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_2_strict_1.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
        "--config",
        "../tb/maintenance_tb/cfg_2_strict_2.txt",
    ],
    [
        python_exe,
        "../script/run_spec_cov.py",
