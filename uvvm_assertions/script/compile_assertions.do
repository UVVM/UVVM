...
#------------------------------------------------------
echo "\n\n=== Re-gen lib and compile $lib_name Assertions source\n"
...
#------------------------------------------------------
# Compile Assertions file
#------------------------------------------------------
echo "\nCompiling $lib_name Assertions source\n"
echo "eval vcom  $compdirectives  $source_path/src/uvvm_assertions_pkg.vhd"
eval vcom  $compdirectives  $source_path/src/uvvm_assertions_pkg.vhd