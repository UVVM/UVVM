...
# Set lib_name
#------------------------------------------------------
quietly set lib_name external_vip_apb
...
echo "eval vcom  $compdirectives  $source_path/src/apb_bfm_pkg.vhd"
eval vcom  $compdirectives  $source_path/src/apb_bfm_pkg.vhd
