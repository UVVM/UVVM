...
def check_result(exp_pass, exp_fail, exp_minor, hr):
    ...
    try:
        raise TestcaseRunError(
            actual=actual_run, expected=(exp_pass + exp_fail))
    ...
    passing_tests, failing_tests, not_run_tests = hr.get_results()
...
def test_bitvis_vip_avalon_mm():
    ...
    # Add TB/TH etc
    hr.add_files("../bitvis_vip_avalon_mm/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_avalon_mm")
    hr.start(sim_options=get_sim_options(hr))
...
def test_bitvis_vip_avalon_st():
    ...
    # 3 sequencer testcases in each testbench.
    created_tests = created_tests * 3
    ...
    # Add TB/TH
    hr.add_files("../bitvis_vip_avalon_st/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_avalon_st")
    hr.start(sim_options=get_sim_options(hr))
...
def test_bitvis_vip_axilite():
    ...
    hr.add_files("../uvvm_vvc_framework/src_target_dependent/*.vhd",
                 "bitvis_vip_axilite")
    # Add TB/TH
    hr.add_files("../bitvis_vip_axilite/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_axilite")
    hr.start(sim_options=get_sim_options(hr))
...
def test_bitvis_vip_axistream():
    ...
    configs = create_config(data_widths=[8, 16, 24, 64, 128], user_widths=[8], id_widths=[
...
def test_bitvis_vip_clock_generator():
    ...
    hr.add_files("../uvvm_vvc_framework/src_target_dependent/*.vhd",
                 "bitvis_vip_clock_generator")
    # Add TB/TH
    hr.add_files("../bitvis_vip_clock_generator/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_clock_generator")
    hr.start(sim_options=get_sim_options(hr))
...
def test_bitvis_vip_error_injection():
    ...
    add_uvvm_basic_files(hr)
    # Add EI VIP
    hr.add_files("../bitvis_vip_error_injection/src/*.vhd",
                 "bitvis_vip_error_injection")
    # Add TB/TH
    hr.add_files("../bitvis_vip_error_injection/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_error_injection")
    hr.add_files("../bitvis_vip_error_injection/tb/*.vhd",
                 "bitvis_vip_error_injection")
    sim_options = "-t ns"
...
def test_bitvis_vip_gmii():
    ...
    # Add TB/TH
    hr.add_files("../bitvis_vip_gmii/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_gmii")
...
def test_bitvis_vip_gpio():
    ...
    # Add TB/TH
    hr.add_files("../bitvis_vip_gpio/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_gpio")
...
def test_bitvis_vip_i2c():
    ...
    # Add TB dependencies
    hr.add_files(
        "../bitvis_vip_i2c/tb/maintenance_tb/fpga_i2c_slave_github/*.vhd", "bitvis_vip_i2c")
    hr.add_files(
        "../bitvis_vip_i2c/tb/maintenance_tb/i2c_opencores/trunk/rtl/vhdl/*.vhd", "bitvis_vip_i2c")
    # Add SBI VIP
    hr.add_files("../bitvis_vip_sbi/src/*.vhd", "bitvis_vip_sbi")
    hr.add_files(
        "../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_sbi")
...
def test_bitvis_vip_rgmii():
    ...
    hr.add_files("../uvvm_vvc_framework/src_target_dependent/*.vhd",
                 "bitvis_vip_rgmii")
    # Add TB/TH
    hr.add_files("../bitvis_vip_rgmii/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_rgmii")
...
def test_bitvis_vip_scoreboard():
    ...
    hr.add_files("../bitvis_uart/src/*.vhd", "bitvis_uart")
    # Add TB/TH
    hr.add_files("../bitvis_vip_scoreboard/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_scoreboard_tb")
    hr.add_files("../bitvis_vip_scoreboard/tb/*.vhd",
                 "bitvis_vip_scoreboard_tb")
    hr.start(sim_options=get_sim_options(hr))
...
def test_bitvis_vip_spec_cov():
    ...
    # Add TB/TH
    hr.add_files("../bitvis_vip_spec_cov/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_spec_cov")
    ...
    hr.add_generics(entity="spec_cov_tb",
                    generics=["GC_REQ_FILE",       ("../bitvis_vip_spec_cov/tb/maintenance_tb/req_file.csv", "PATH"),
                              "GC_REQ_FILE_EMPTY", (
                        "../bitvis_vip_spec_cov/tb/maintenance_tb/req_file_empty.csv", "PATH"),
                        "GC_SUB_REQ_FILE",   (
                        "../bitvis_vip_spec_cov/tb/maintenance_tb/sub_req_file.csv", "PATH"),
...
def test_bitvis_vip_spi():
    ...
    def create_config(spi_modes, data_widths, data_array_widths):
        ...
        for spi_mode, data_width, data_array_width in product(spi_modes, data_widths, data_array_widths):
            config.append(
                [str(spi_mode), str(data_width), str(data_array_width)])
        return config
    ...
    hr.add_files(
        "../bitvis_vip_spi/tb/maintenance_tb/spi_master_slave_opencores/trunk/rtl/spi_master_slave/spi_master.vhd", "bitvis_vip_spi")
    hr.add_files(
        "../bitvis_vip_spi/tb/maintenance_tb/spi_master_slave_opencores/trunk/rtl/spi_master_slave/spi_slave.vhd", "bitvis_vip_spi")
    hr.add_files("../bitvis_vip_spi/tb/maintenance_tb/spi_pif.vhd",
                 "bitvis_vip_spi")
...
def test_bitvis_vip_uart():
    ...
    hr.add_files(
        "../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_uart")
    # Add TB/TH
    hr.add_files("../bitvis_vip_uart/tb/maintenance_tb/*.vhd",
                 "bitvis_vip_uart")
...
def test_bitvis_vip_ethernet():
    ...
    hr.add_files(
        "../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/xilinx/unisims/*.vhd", "unisim")  # 08
    hr.add_files("../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/xilinx/unisims/primitive/*.vhd",
                 "unisim", com_options=compile_directives_93)
    hr.add_files(
        "../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/*.vhd", "mac_master")
    hr.add_files(
        "../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/xilinx/*.vhd", "mac_master")
    hr.add_files(
        "../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/generic/*.vhd", "mac_master")
    hr.add_files(
        "../bitvis_vip_ethernet/tb/maintenance_tb/ethernet_mac-master/xilinx/ipcore_dir/*.vhd", "mac_master")
...
def test_uvvm_vvc_framework():
    ...
    hr.add_files(
        "../uvvm_vvc_framework/tb/maintenance_tb/reference_vvcs/src/*sbi*.vhd", "bitvis_vip_sbi")
    hr.add_files(
        "../uvvm_vvc_framework/tb/maintenance_tb/reference_vvcs/src/*uart*.vhd", "bitvis_vip_uart")
    hr.add_files("../uvvm_vvc_framework/tb/maintenance_tb/*.vhd",
                 "testbench_lib")
    sim_options = "-t ns"
    hr.start(sim_options='-t ns')
...
def main():
    ...
    if not os.path.isdir("../uvvm_util"):
