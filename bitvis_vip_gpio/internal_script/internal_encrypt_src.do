...
# Set up bitvis_vip_gpio_part_path 
#------------------------------------------------------
quietly set part_name "bitvis_vip_gpio"
# path from mpf-file in sim
quietly set bitvis_vip_gpio_part_path "../..//$part_name"

if { [info exists 1] } {
  # path from this part to target part
  quietly set bitvis_vip_gpio_part_path "$1/..//$part_name"
  unset 1
}
...
quietly set sourcedir "$bitvis_vip_gpio_part_path/src"
