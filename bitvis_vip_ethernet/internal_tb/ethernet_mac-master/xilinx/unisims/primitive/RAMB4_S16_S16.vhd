...
-- /___/   /\     Filename : RAMB4_S16_S16.vhd
...
entity RAMB4_S16_S16 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB4_S16_S16 : entity is true;
end ramb4_s16_s16;

architecture RAMB4_S16_S16_V of RAMB4_S16_S16 is
  attribute VITAL_LEVEL0 of
    RAMB4_S16_S16_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable ADDRA_ipd_sampled : std_logic_vector(7 downto 0) := (others => 'X');
              ...
              if ((collision_type = 1) or (collision_type = 3)) then
                Memory_Collision_Msg
                  (collision_type => Write_A_Write_B,
                   EntityName => "RAMB4_S16_S16",
                   InstanceName => ramb4_s16_s16'path_name,
