set lib_name "bitvis_vip_avalon_st"
...
#------------------------------------------------------
set root_path "../.."
set tb_path "$root_path/bitvis_vip_avalon_st/tb/maintenance_tb"
echo "\n\n\n=== Compiling TB\n"
...
echo "eval vcom  $compdirectives  $tb_path/avalon_st_vvc_tb.vhd"
eval vcom  $compdirectives  $tb_path/avalon_st_vvc_tb.vhd