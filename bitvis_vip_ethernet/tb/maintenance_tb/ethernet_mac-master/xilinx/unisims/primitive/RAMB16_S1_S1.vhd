...
entity RAMB16_S1_S1 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S1 : entity is true;
end ramb16_s1_s1;

architecture RAMB16_S1_S1_V of RAMB16_S1_S1 is
  attribute VITAL_LEVEL0 of
    RAMB16_S1_S1_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable INI_B             : std_logic_vector (0 downto 0)              := "0";
    ...
    variable SRVA_B            : std_logic_vector (0 downto 0)              := "0";
    ...
    variable DOB_zd  : std_logic_vector(0 downto 0) := INI_B(0 downto 0);

    variable ADDRA_ipd_sampled : std_logic_vector(13 downto 0) := (others => 'X');
    variable ADDRB_ipd_sampled : std_logic_vector(13 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_B'length > 1) then
        ...
        INI_B(0 downto 0)                      := INI_B_UNBOUND(0 downto 0);

        for I in INI_B_UNBOUND'high downto 1 loop
      ...
      if (SRVAL_B'length > 1) then
        ...
        SRVA_B(0 downto 0)                       := SRVA_B_UNBOUND(0 downto 0);

        for I in SRVA_B_UNBOUND'high downto 1 loop
      ...
      DOB_zd(0 downto 0) := INI_B(0 downto 0);
      DOA  <= DOA_zd;
      DOB  <= DOB_zd;
    ...
    if (TimingChecksOn) then
      ...
      VitalSetupHoldCheck (
        ...
        HoldLow        => thold_ADDRB_CLKB_posedge_posedge(12),
        HoldHigh       => thold_ADDRB_CLKB_negedge_posedge(12),
        CheckEnabled   => TO_X01(enb_ipd_sampled) = '1',
        RefTransition  => 'R',
        HeaderMsg      => "/${CELL}",
        Xon            => Xon,
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S1_S1",
                       InstanceName => ramb16_s1_s1'path_name,
