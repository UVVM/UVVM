-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/unisims/unisim/VITAL/RAMB16_S18.vhd,v 1.1 2008/06/19 16:59:25 vandanad Exp $
-------------------------------------------------------------------------------
...
-- /___/   /\     Filename : RAMB16_S18.vhd
-- \   \  /  \    Timestamp : Thu Apr  8 10:56:50 PDT 2004
--  \___\/\___\
--
-- Revision:
...
architecture RAMB16_S18_V of RAMB16_S18 is
...
begin
  ...
  VITALBehavior : process
    ...
    variable INIT_reg         : std_logic_vector (17 downto 0) := "000000000000000000";
    variable SRVAL_reg         : std_logic_vector (17 downto 0) := "000000000000000000";        
  ...
  begin
    if (first_time) then
      ...
      if (INIT'length > 18) then
        INIT_reg(17 downto 0) := To_StdLogicVector(INIT)(17 downto 0);
      else
        INIT_reg(INIT'length-1 downto 0) := To_StdLogicVector(INIT);
      end if;
      
      DO <= INIT_reg(15 downto 0);
      DOP <= INIT_reg(17 downto 16);
      
      if (SRVAL'length > 18) then
        SRVAL_reg(17 downto 0) := To_StdLogicVector(SRVAL)(17 downto 0);
      else
    ...
    if (rising_edge(CLK)) then
      if (EN = '1') then
        if (SSR = '1') then
          DO <= SRVAL_reg(15 downto 0) after 100 ps;
