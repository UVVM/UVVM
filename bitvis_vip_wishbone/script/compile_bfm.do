...
# Set up vip_wishbone_part_path and lib_name
#------------------------------------------------------
...
if {[file exists $vip_wishbone_part_path/sim/$lib_name]} {
  file delete -force $vip_wishbone_part_path/sim/$lib_name
}
echo "\n\n****\n"
if {![file exists $vip_wishbone_part_path/sim]} {
  file mkdir $vip_wishbone_part_path/sim
}

vlib $vip_wishbone_part_path/sim/$lib_name
vmap $lib_name $vip_wishbone_part_path/sim/$lib_name
...
eval vcom  $compdirectives  $vip_wishbone_part_path/src/wishbone_bfm_pkg.vhd
