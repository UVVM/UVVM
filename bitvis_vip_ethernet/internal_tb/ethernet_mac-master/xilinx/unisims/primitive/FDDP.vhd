-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/unisims/cpld/VITAL/FDDP.vhd,v 1.1 2008/06/19 16:59:21 vandanad Exp $
-------------------------------------------------------------------------------
...
attribute VITAL_LEVEL0 of FDDP : entity is TRUE;
end FDDP;
...
library UNISIM;
use unisim.VPKG.all;
architecture FDDP_V of FDDP is
   --attribute VITAL_LEVEL1 of FDDP_V : architecture is TRUE;
...
begin
   ...
   begin
     ...
     if (FIRST_TIME = TRUE) then
      ...
      -------------------------
      Violation := Tviol_D_C_posedge or Tviol_PRE_C_posedge or Pviol_PRE or Pviol_C;
      VitalStateTable(
        Result => Q_zd,
        PreviousDataIn => PrevData_Q,
        StateTable => FDDP_Q_tab,
        DataIn => (
               C_delayed, D_delayed, PRE_ipd, C_ipd));
