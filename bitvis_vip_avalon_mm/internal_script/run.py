...
def create_config(modes):
  config = []
  for mode in product(modes):
    config.append(str(mode))
...
def main(argv):
  ...
  # Set testbench
  testbench = "avalon_mm_vvc_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)


  # Set testbench
  testbench = "avalon_mm_tb" #"avalon_mm_simple_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)


  # Set testbench
  testbench = "avalon_mm_spi_tb" #"avalon_mm_simple_spi_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)
  ...
  configs = ["true", "false"]
  # Set testbench
  testbench = "avalon_mm_vvc_pipeline_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)
