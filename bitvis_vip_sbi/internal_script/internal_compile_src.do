...
eval vcom  $compdirectives  $vip_sbi_part_path/src/vvc_cmd_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/../uvvm_vvc_framework/src_target_dependent/internal_td_target_support_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/../uvvm_vvc_framework/src_target_dependent/internal_td_vvc_framework_common_methods_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/src/vvc_methods_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/../uvvm_vvc_framework/src_target_dependent/td_queue_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/../uvvm_vvc_framework/src_target_dependent/internal_td_vvc_entity_support_pkg.vhd
eval vcom  $compdirectives  $vip_sbi_part_path/src/sbi_vvc.vhd
