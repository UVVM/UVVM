...
if {[file exists $bitvis_vip_uart_part_path/sim/$lib_name]} {
  file delete -force $bitvis_vip_uart_part_path/sim/$lib_name
}
if {![file exists $bitvis_vip_uart_part_path/sim]} {
  file mkdir $bitvis_vip_uart_part_path/sim
}

vlib $bitvis_vip_uart_part_path/sim/$lib_name
vmap $lib_name $bitvis_vip_uart_part_path/sim/$lib_name
...
eval vcom  $compdirectives  $bitvis_vip_uart_part_path/src/uart_bfm_pkg.vhd
