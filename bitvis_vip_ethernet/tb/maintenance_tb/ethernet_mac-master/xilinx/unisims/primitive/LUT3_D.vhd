-- $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/vhdsclibs/data/unisims/unisim/VITAL/LUT3_D.vhd,v 1.1 2008/06/19 16:59:24 vandanad Exp $
-------------------------------------------------------------------------------
...
begin
  ...
  begin
    ...
    if ((I2 xor I1 xor I0) = '1' or (I2 xor I1 xor I0) = '0') then
       ...
       tmp_o := lut4_mux4(('0' & '0' & lut4_mux4(INIT_reg(7 downto 4), I_reg(1 downto 0)) &
