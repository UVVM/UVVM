...
# Set up uvvm_vvc_framework_part_path 
#------------------------------------------------------
...
#############################################################
## Encrypt the target independent source
#############################################################                
  
quietly set sourcedir "$uvvm_vvc_framework_part_path/src"
...
#############################################################
## Encrypt the target dependent source
#############################################################

quietly set sourcedir "$uvvm_vvc_framework_part_path/src_target_dependent"
