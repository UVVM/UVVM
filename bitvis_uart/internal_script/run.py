...
def main(argv):
  ...
  # Setup testbench
  tests = []
  testbench = "uart_simple_bfm_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)


  # Setup testbench
  tests = [ "check_register_defaults",
            "check_simple_transmit",
            "check_simple_receive",
            "check_single_simultaneous_transmit_and_receive",
            "check_multiple_simultaneous_receive_and_read",
            "skew_sbi_read_over_uart_receive",
            "skew_sbi_read_over_uart_receive_with_delay_functionality"
            ]
  testbench = "uart_vvc_tb"
  # Run testbench with defined tests
  run_simulation(library, testbench, tests, configs, verbose)
