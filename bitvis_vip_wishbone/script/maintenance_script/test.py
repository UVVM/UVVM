...
print("Verify Bitvis VIP Wishbone")
...
# Add Wishbone VIP
hr.add_files("../../src/*.vhd", "bitvis_vip_wishbone")
hr.add_files("../../../uvvm_vvc_framework/src_target_dependent/*.vhd", "bitvis_vip_wishbone")
# Add TB/TH
hr.add_files("../../tb/maintenance_tb/*.vhd", "bitvis_vip_wishbone")

# Setup VVC TB test generics
hr.add_generics(entity="wishbone_vvc_tb", generics=["GC_DATA_WIDTH", 8])
hr.add_generics(entity="wishbone_vvc_tb", generics=["GC_DATA_WIDTH", 32])
