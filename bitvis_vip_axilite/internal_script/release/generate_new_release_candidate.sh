...
# The final step is to update bitvis_vip_axilite/VERSION.TXT
#
...
select yn in "Yes" "No"; do
    case $yn in
        Yes ) python git-release/git-release.py -r bitvis_vip_axilite -x uvvm_vvc_framework uvvm_util vunit; exit;;
        No ) exit;;
    esac
done