...
entity RAMB16_S18_S18 is
  ...
  attribute VITAL_LEVEL0 of
    RAMB16_S18_S18 : entity is true;
end ramb16_s18_s18;

architecture RAMB16_S18_S18_V of RAMB16_S18_S18 is
  attribute VITAL_LEVEL0 of
    RAMB16_S18_S18_V : architecture is true;
...
begin
  ...
  VITALBehavior                        : process
    ...
    variable DOPA_OV_MSB       : integer := 1;
    variable DOPB_OV_LSB       : integer := 0;
    variable DOPB_OV_MSB       : integer := 1;
    ...
    variable INI_A             : std_logic_vector (17 downto 0)              := "000000000000000000";
    variable INI_A_UNBOUND     : std_logic_vector (INIT_A'length-1 downto 0);
    variable INI_B             : std_logic_vector (17 downto 0)              := "000000000000000000";
    ...
    variable SRVA_A            : std_logic_vector (17 downto 0)              := "000000000000000000";
    variable SRVA_A_UNBOUND    : std_logic_vector (SRVAL_A'length-1 downto 0);
    variable SRVA_B            : std_logic_vector (17 downto 0)              := "000000000000000000";
    ...
    variable DOA_zd  : std_logic_vector(15 downto 0) := INI_A(15 downto 0);
    variable DOB_zd  : std_logic_vector(15 downto 0) := INI_B(15 downto 0);
    variable DOPA_zd : std_logic_vector(1 downto 0)  := INI_A(17 downto 16);
    variable DOPB_zd : std_logic_vector(1 downto 0)  := INI_B(17 downto 16);

    variable ADDRA_ipd_sampled : std_logic_vector(9 downto 0) := (others => 'X');
    variable ADDRB_ipd_sampled : std_logic_vector(9 downto 0) := (others => 'X');
  ...
  begin
    if (FIRST_TIME) then
      ...
      if (INIT_A'length > 18) then
        ...
        INI_A(17 downto 0)                      := INI_A_UNBOUND(17 downto 0);

        for I in INI_A_UNBOUND'high downto 18 loop
        ...
        if (IS_VALID = true) then
          ...
          GenericValueCheckMessage
            (HeaderMsg            => " Attribute Syntax Warning ",
             ...
             ExpectedGenericValue => 18,
             TailMsg              => "",
             MsgSeverity          => warning
             );
        end if;

      elsif (INIT_A'length < 18) then
      ...
      if (INIT_B'length > 18) then
        ...
        INI_B(17 downto 0)                      := INI_B_UNBOUND(17 downto 0);

        for I in INI_B_UNBOUND'high downto 18 loop
      ...
      if (SRVAL_A'length > 18) then
        ...
        SRVA_A(17 downto 0)                       := SRVA_A_UNBOUND(17 downto 0);

        for I in SRVA_A_UNBOUND'high downto 18 loop
      ...
      if (SRVAL_B'length > 18) then
        ...
        SRVA_B(17 downto 0)                       := SRVA_B_UNBOUND(17 downto 0);

        for I in SRVA_B_UNBOUND'high downto 18 loop
      ...
      DOA_zd(15 downto 0) := INI_A(15 downto 0);
      DOB_zd(15 downto 0) := INI_B(15 downto 0);
      DOPA_zd(1 downto 0) := INI_A(17 downto 16);
      DOPB_zd(1 downto 0) := INI_B(17 downto 16);
      DOA  <= DOA_zd;
      DOPA <= DOPA_zd;
      DOB  <= DOB_zd;
      DOPB <= DOPB_zd;
    ...
    if (ena_ipd_sampled = '1')then
      if (rising_edge(CLKA_ipd)) then
                  ...
                  if ((collision_type = 1) or (collision_type = 3)) then
                    Memory_Collision_Msg
                      (collision_type => Write_A_Write_B,
                       EntityName => "RAMB16_S18_S18",
                       InstanceName => ramb16_s18_s18'path_name,
        ...
        if (ssra_ipd_sampled = '1') then
          DOA_zd  := SRVA_A(15 downto 0);
          DOPA_zd := SRVA_A(17 downto 16);
        end if;
      end if;
    end if;
    ...
    if (enb_ipd_sampled = '1') then
      if (rising_edge(CLKB_ipd)) then
        ...
        if (ssrb_ipd_sampled = '1') then
          DOB_zd  := SRVA_B(15 downto 0);
          DOPB_zd := SRVA_B(17 downto 16);
        end if;
      end if;
    end if;
